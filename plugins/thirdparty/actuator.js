...
(function () {
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [
            ...
            {
                name: "on_request_type",
                display_name: "On Request Type",
                type: "option",
                options: [{
                    name: "GET",
                    value: "GET"
    ...
    var actuator = function (settings) {
        ...
        this.onClick = function(e) {
            ...
            type = (new_val) ? currentSettings.on_request_type : currentSettings.off_request_type;
            if (_.isUndefined(url))
                freeboard.showDialog($("<div align='center'>url undefined</div>"), "Error!", "OK", null, function () {
                });
            else {
                this.sendValue(url, type, new_val);
            }
        ...
        this.sendValue = function (url, type, options) {
